...
- **SanoC APIs (Mar 2025)**  
  ...
  **Tech Stack**: Node.js, Express, Firebase/Firestore, Cloudinary.  
  [GitHub Link](https://github.com/Ltk-Mxz/sanoc-backend)

- **Kadodo Intranet (Apr 2025)**  
  A secure academic platform for students, professors, and administrators with role-based access.  
...
- **Portfolio (Since Jun 2024)**  
  ...
  **Tech Stack**: Node.js, Passport.js, Multer.  
  [GitHub Link](#)
